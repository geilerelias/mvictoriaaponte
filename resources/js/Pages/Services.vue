<template>
    <app-layout>
        <div>
            <section>
                <v-img
                    src="/src/images/header/capacitacion.jpg"
                    ...
                    <v-row class="mb-5 align-center" v-for="(item,i) in services" :key="i" :id="item.title">
                        ...
                        <v-col class="px-0 col-md-8 col-12">
                            <v-card flat class="transparent">
                                ...
                                <v-card-text class="overflow-y-auto" style="height: 250px;">
                                    <perfect-scrollbar v-html="item.content">
                                    </perfect-scrollbar>
                                </v-card-text>
...
export default {
    ...
    data: () => ({
        ...
        services: [
            {
                image: '/src/images/servicios/capacitacion 2.jpg',
                title: 'CAPACITACIÓN',
            ...
            {
                image: '/src/images/servicios/accesorias 2.jpg',
                title: 'ASESORÍAS',
            ...
            {
                image: '/src/images/servicios/investigacion 3.jpg',
                title: 'INVESTIGACIÓN',
            ...
            {
                image: '/src/images/servicios/circulo-de-poder 2.jpg',
            ...
            {
                image: '/src/images/servicios/cohaching 2.jpg',
                title: 'COACHING',
